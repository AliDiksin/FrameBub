...
from bubbot.frame_data import ggst_output
...
clean_value = ggst_output.clean_value
truncate_value = ggst_output.truncate_value
add_embed_field = ggst_output.add_embed_field
add_long_embed_field = ggst_output.add_long_embed_field
format_jsonish_list = ggst_output.format_jsonish_list
get_notes_text = ggst_output.get_notes_text
format_frame_data = ggst_output.format_frame_data
get_move_image_url = ggst_output.get_move_image_url
build_frame_embed = ggst_output.build_frame_embed
get_hitbox_links = ggst_output.get_hitbox_links
get_media_links = ggst_output.get_media_links
GGSTNotesButton = ggst_output.GGSTNotesButton
send_frame_response = ggst_output.send_frame_response
send_hitbox_response = ggst_output.send_hitbox_response
...
def _sync_output():
    ggst_output.configure(
        GGST_MOVE_IMAGE_URLS=GGST_MOVE_IMAGE_URLS,
        GGST_HITBOX_DATA=GGST_HITBOX_DATA,
        GGST_MOVE_NOTES=GGST_MOVE_NOTES,
        normalize_move_token=normalize_move_token,
        resize_mediawiki_thumb_url=resize_mediawiki_thumb_url,
    )
